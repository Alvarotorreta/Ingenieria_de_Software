  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (email && password) {
        ...
        // 🔹 Redirigir siempre a /profesor/home
        ...
        >
          <div className="bg-white rounded-3xl shadow-2xl p-8 space-y-8">
            ...
            <div className="text-center space-y-4">
              ...
              <h1 className="text-[#093c92]">Iniciar Sesión</h1>
              <p className="text-gray-600">Bienvenido al Juego de Emprendimiento UDD</p>
            </div>
            ...
            {/* Accesos rápidos para prototipo */}
