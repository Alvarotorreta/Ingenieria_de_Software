import { imgGroup, imgGroup1 } from "./svg-5woml";
...
export default function PersonalizacionDeLosGrupos() {
  return (
    <div className="bg-[#093c92] relative size-full" data-name="Personalizacion de los grupos">
      <div className="absolute bg-[#e1e900] h-[150px] left-[127px] rounded-[10px] top-[601px] w-[494px]" />
      <div className="absolute bg-black h-[100px] left-[1063px] rounded-[15px] top-[129px] w-[240px]" />
      <Welcome />
      <Seconds />
      <Minutes />
      <div className="absolute bg-[#43f61f] h-[150px] left-[127px] rounded-[10px] top-[383px] w-[494px]" data-name="Rounded rectangle" />
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[371px] text-[36px] text-center text-white top-[443px] translate-x-[-50%] w-[382px]">“Dream Team”</p>
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[25px] leading-[normal] left-[359.5px] text-[24px] text-black text-center top-[383px] translate-x-[-50%] w-[381px]">Grupo 1</p>
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[25px] leading-[normal] left-[359.5px] text-[24px] text-black text-center top-[383px] translate-x-[-50%] w-[381px]">Grupo 1</p>
      <div className="absolute bg-[#f61a1a] h-[150px] left-[714px] rounded-[10px] top-[383px] w-[494px]" />
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[966px] text-[36px] text-center text-white top-[450px] translate-x-[-50%] w-[382px]">“Dream Team”</p>
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[371px] text-[36px] text-center text-white top-[662px] translate-x-[-50%] w-[382px]">“Dream Team”</p>
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[25px] leading-[normal] left-[956.5px] text-[24px] text-black text-center top-[383px] translate-x-[-50%] w-[381px]">Grupo 2</p>
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[25px] leading-[normal] left-[359.5px] text-[24px] text-black text-center top-[601px] translate-x-[-50%] w-[381px]">Grupo 3</p>
      <div className="absolute bg-[#ac57f7] h-[150px] left-[714px] rounded-[10px] top-[601px] w-[494px]" />
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[958px] text-[36px] text-center text-white top-[656px] translate-x-[-50%] w-[382px]">Eligiendo nombre...</p>
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[25px] leading-[normal] left-[956.5px] text-[24px] text-black text-center top-[601px] translate-x-[-50%] w-[381px]">Grupo 4</p>
      <SendCodeButton />
