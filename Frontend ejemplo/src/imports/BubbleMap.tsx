import { imgGroup, imgGroup1 } from "./svg-dxphw";
...
function Welcome() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[84px] items-start left-[151px] top-[118px] w-[615px]" data-name="Welcome">
      <p className="font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold leading-[normal] relative shrink-0 text-[#fbc95c] text-[48px] w-[912px]">Etapa 2: Bubble map</p>
    </div>
  );
}
...
export default function BubbleMap() {
  return (
    <div className="bg-[#093c92] relative size-full" data-name="Bubble map">
      ...
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[395px] text-[36px] text-center text-white top-[402px] translate-x-[-50%] w-[382px]">Bubble map Listo</p>
