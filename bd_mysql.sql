-- =========================================================
-- Base de datos: Juego de Emprendimiento (MySQL)
...
CREATE TABLE TipoPregunta (
    id_tipoPregunta INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    descripcion     TEXT
);
...
CREATE TABLE TipoActividad (
    id_tipoActividad  INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Desafio (
    id_desafio      INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Equipo (
    ...
    modalidad       TINYINT(1) NOT NULL DEFAULT 0,  -- se conocen? 0=false/1=true
...
CREATE TABLE RegistroTokens (
    id_registro_tokens  INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE RespuestaEncuesta (
    id_respuestaEncuesta INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    respuesta            TEXT,
    id_alumno            INT NOT NULL,
