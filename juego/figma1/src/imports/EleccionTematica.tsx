import { imgGroup, imgGroup1 } from "./svg-u6mlz";
...
function Welcome() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[84px] items-start left-[151px] top-[118px] w-[615px]" data-name="Welcome">
      <p className="font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold leading-[normal] relative shrink-0 text-[#fbc95c] text-[48px] w-[912px]">Etapa 2: Elección tematica</p>
    </div>
  );
}
...
export default function EleccionTematica() {
  return (
    <div className="bg-[#093c92] relative size-full" data-name="Eleccion tematica">
      ...
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[395px] text-[36px] text-center text-white top-[402px] translate-x-[-50%] w-[382px]">“Fast Fashion”</p>
      ...
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[990px] text-[36px] text-center text-white top-[409px] translate-x-[-50%] w-[382px]">“Adultos mayores”</p>
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[395px] text-[36px] text-center text-white top-[621px] translate-x-[-50%] w-[382px]">“Sustentabilidad del agua en agricultura”</p>
      ...
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[982px] text-[36px] text-center text-white top-[615px] translate-x-[-50%] w-[382px]">Eligiendo tematica...</p>
