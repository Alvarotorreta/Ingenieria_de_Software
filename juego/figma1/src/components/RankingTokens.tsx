...
export default function RankingTokens({ grupos, etapa, onContinuar }: RankingTokensProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-[#093c92] via-blue-700 to-[#f757ac] z-50 flex items-center justify-center p-8">
