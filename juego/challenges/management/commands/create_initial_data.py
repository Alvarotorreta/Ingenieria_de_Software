    ...
    def handle(self, *args, **options):
        ...
        presentation_activity, created = Activity.objects.get_or_create(
            ...
            defaults={
                ...
                'name': 'Presentación',
                'description': 'Minijuego de anagramas: adivina las palabras desordenadas (3 palabras, 5 tokens cada una = 15 tokens total)',
                'order_number': 2,
        ...
        if created:
            ...
            presentation_activity.description = 'Minijuego de anagramas: adivina las palabras desordenadas (3 palabras, 5 tokens cada una = 15 tokens total)'
