...
class TeamActivityProgressSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'pitch_intro_problem', 'pitch_solution', 'pitch_closing'
        ]
...
class TokenTransactionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'session_stage', 'amount', 'source_type', 'source_id', 'reason',
            'awarded_by', 'awarded_by_name', 'created_at'
        ]
        read_only_fields = ['id', 'team_name', 'game_session_room_code', 'awarded_by_name', 'created_at']
