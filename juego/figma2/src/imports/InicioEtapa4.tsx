import { imgGroup, imgGroup1 } from "./svg-n7cb9";
...
export default function InicioEtapa() {
  return (
    <div className="bg-[#093c92] relative size-full" data-name="Inicio etapa 4">
      <Welcome />
      <div className="absolute bg-black h-[100px] left-[1063px] rounded-[15px] top-[129px] w-[240px]" />
      <Seconds />
      <Minutes />
      <Frame3 />
      <p className="absolute font-['Plus_Jakarta_Sans:SemiBold',_sans-serif] font-semibold h-[240px] leading-[normal] left-[185px] text-[40px] text-justify text-white top-[392px] w-[1057px]">
        <span className="font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold text-[#f757ac]">{`Comunicar `}</span>
        <span>{`bien una idea es crucial ya que asegura que todos los involucrados comprendan y apoyen la visión y los objetivos del proyecto. En emprendimiento se utiliza el concepto de hacer un "pitch", que significa presentar de manera concisa y persuasiva una propuesta o proyecto`}</span>
      </p>
      <SendCodeButton />
