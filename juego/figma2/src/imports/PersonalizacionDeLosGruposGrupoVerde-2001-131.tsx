import { imgGroup, imgGroup1 } from "./svg-pr5j4";
...
function Welcome() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[84px] items-start left-[151px] top-[118px] w-[615px]" data-name="Welcome">
      <p className="font-['Plus_Jakarta_Sans:ExtraBold',sans-serif] font-extrabold leading-[normal] relative shrink-0 text-[#fbc95c] text-[48px] w-[912px]">Personalización de equipos</p>
    </div>
  );
}
...
function Seconds() {
  return (
    <div className="absolute bg-black content-stretch flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal items-center leading-[0] left-[1190px] text-[#f757ac] text-center text-nowrap top-[130px]" data-name="seconds">
...
function Minutes() {
  return (
    <div className="absolute bg-black content-stretch flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal h-[85px] items-center leading-[0] left-[1085px] text-[#f757ac] text-center text-nowrap top-[130px]" data-name="minutes">
      <div className="flex flex-col justify-center relative shrink-0 text-[48px] tracking-[0.48px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Welcome1() {
  return (
    <div className="absolute bg-[#093c92] content-stretch flex flex-col gap-[8px] items-start left-[29px] top-[946px] w-[178px]" data-name="Welcome">
      <p className="font-['Plus_Jakarta_Sans:ExtraBold',sans-serif] font-extrabold leading-[normal] relative shrink-0 text-[#43f61f] text-[48px] w-full">Grupo 1</p>
    </div>
  );
}
...
function Password() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Password">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[32px] text-white w-full">Nombre del grupo</p>
      <Frame1 />
    </div>
  );
}
    ...
    <div className="relative rounded-[16px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center pl-[24px] pr-[100px] py-[12px] relative w-full">
          <p className="basis-0 font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[#c2c2c2] text-[16px]">Selecciona una opcion</p>
        </div>
      </div>
    </div>
  );
...
function Password1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Password">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[32px] text-white w-full">¿Los integrantes del grupo se conocen?</p>
      <Frame2 />
    </div>
  );
}
...
function SendCodeButton() {
  return (
    <div className="absolute contents left-[504px] top-[652px]" data-name="Send Code (Button)">
      ...
      <p className="absolute font-['Urbanist:SemiBold',sans-serif] font-semibold h-[23.858px] leading-[normal] left-[715.04px] text-[15px] text-center top-[677.18px] translate-x-[-50%] w-[95.638px]">Send Code</p>
      <ClipPathGroup1 />
    </div>
  );
}
...
function Frame9() {
  return <div className="absolute left-[598px] size-[100px] top-[860px]" />;
}
...
export default function PersonalizacionDeLosGruposGrupoVerde() {
  return (
    <div className="bg-[#093c92] relative size-full" data-name="Personalizacion de los grupos 'Grupo Verde'">
      ...
      <Data />
      <SendCodeButton />
      <p className="absolute font-['Urbanist:SemiBold',sans-serif] font-semibold leading-[normal] left-[698.5px] text-[40px] text-center text-nowrap text-white top-[659px] translate-x-[-50%] whitespace-pre">Listo</p>
      <Frame9 />
    </div>
  );
}