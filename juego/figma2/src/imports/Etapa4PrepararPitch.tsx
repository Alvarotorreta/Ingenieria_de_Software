import { imgGroup, imgGroup1 } from "./svg-hb5qr";
...
function Welcome() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[84px] items-start left-[151px] top-[118px] w-[615px]" data-name="Welcome">
      <p className="font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold leading-[normal] relative shrink-0 text-[#fbc95c] text-[48px] w-[912px]">Etapa 4: Preparar pitch</p>
    </div>
  );
}
...
export default function Etapa4PrepararPitch() {
  return (
    <div className="bg-[#093c92] relative size-full" data-name="Etapa 4: Preparar pitch">
      ...
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[430px] text-[36px] text-center text-white top-[624px] translate-x-[-50%] w-[382px]">Pitch en progreso...</p>
      ...
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[30px] leading-[normal] left-[990px] text-[36px] text-center text-white top-[409px] translate-x-[-50%] w-[382px]">Pitch en progreso...</p>
      ...
      <p className="absolute font-['Plus_Jakarta_Sans:ExtraBold',_sans-serif] font-extrabold h-[37px] leading-[normal] left-[984px] text-[36px] text-center text-white top-[621px] translate-x-[-50%] w-[382px]">Pitch en progreso...</p>
